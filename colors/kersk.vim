...
"
" kersk.vim - slightly tweaked wombat256.vim
"
...
"call <SID>X("Normal",		"eeeeee",	"202020",	"none")
...
"call <SID>X("Search",		"000000",	"2066ff",	"")
call <SID>X("Search",		"000000",	"3066bb",	"")
"call <SID>X("MatchParen",	"ecee90",	"857b6f",	"bold")
"call <SID>X("MatchParen",	"ecee90",	"2066ff",	"bold")
call <SID>X("MatchParen",	"ecee90",	"206699",	"bold")
...
call <SID>X("WarningMsg",	"ff0000",	"",			"")
			...
			"MoreMsg
			"Directory
call <SID>X("DiffAdd",		"000000",	"008800",	"bold")
call <SID>X("DiffChange",	"000000",	"666600",	"bold")
call <SID>X("DiffDelete",	"000000",	"880000",	"bold")
call <SID>X("DiffText",		"000000",	"ffff00",	"bold")
